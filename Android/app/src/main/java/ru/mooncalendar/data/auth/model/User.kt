...
enum class AdviceState(val text: String, val color: Color) {
    ...
    Neutral("нейтральный", Color.Gray),
...
data class User(
    ...
    fun getMyMonth(currentYear: Int, currentMonth: Int): Pair<Int, String> {
        ...
        return sum to when(sum) {
            1 -> {
                "Месяц Солнца — это начало новой жизни.\n" +
            ...
            2 -> {
                "В этот месяц человеку нельзя принимать серьёзных решений.\n" +
                        "\n" +
            ...
            3 -> {
                "Месяц анализа и успеха (Полезный анализ).\n" +
            ...
            8 -> {
                "Надо работать над качеством работы/учебы. В этот месяц необходимо много учиться и много работать, т.е. инвестировать в обучение. \n" +
            ...
            9 -> {
                "Месяц, когда может быть разрушено всё то, что долго создавалось. В этот год человек может умереть (могут умереть близкие, заканчивается работа).\n" +
                        "\n" +
